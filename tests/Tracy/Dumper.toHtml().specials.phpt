...
fclose($f);
Assert::match(<<<'XX'
<pre class="tracy-dump--light"><span class="tracy-dump-resource">closed resource</span> <span class="tracy-dump-hash">@%d%</span></pre>
XX
, Dumper::toHtml($f));
...
// closure
Assert::match(<<<'XX'
<pre class="tracy-dump--light"><span class="tracy-dump-object">Closure()</span> <span class="tracy-dump-hash">#%d%</span></pre>
XX
...
// new class
Assert::match(<<<'XX'
<pre class="tracy-dump--light"><span class="tracy-dump-object">class@anonymous</span> <span class="tracy-dump-hash">#%d%</span></pre>
XX
